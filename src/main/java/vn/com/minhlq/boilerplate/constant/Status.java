...
public enum Status implements IStatus {
    ...
    /**
     * Current user already login in somewhere. Please try to change the password or login again!
     */
    TOKEN_OUT_OF_CTRL(5003, "Current user already login in somewhere. Please try to change the password or login again!"),

    /**
     * Unable to kick out yourself. Please try to logout!
     */
    KICK_OUT_SELF(5004, "Unable to kick out yourself. Please try to logout!");
